...
namespace Vitrine\ClienteBundle\Controller;
...
use Vitrine\ClienteBundle\Entity\Cliente;
use Vitrine\ClienteBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VitrineClienteBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("VitrineClienteBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VitrineClienteBundle:Cliente')->find($id);
     ...
     * @Method("PUT")
     * @Template("VitrineClienteBundle:Cliente:edit.html.twig")
     */
